...
<body>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td data-label="Unit">{{ $item->school_name }}</td>
            <td data-label="Code">{{ $item->school_string }}</td>
            <td data-label="Department">{{ $item->created_at }}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
