...
<body>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td data-label="Unit">{{ $item->lecturer_name }}</td>
            <td data-label="Code">{{ $item->lecturer_email }}</td>
            <td data-label="Course">{{ $item->department_name }}</td>
            <td data-label="Department">{{ $item->lecturer_contact }}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
